...
class TestAddRemoveHandlers:
    ...
    def test_removing_none_when_no_handlers(self):
        """
    ...
    def test_removing_when_no_handlers(self):
        """
    ...
    # noinspection PyTypeChecker
    def test_adding_non_when_no_handlers(self):
        """
        Simple checks to just make sure there are no errors.
        """
        go = GameObject()
    ...
    def test_adding_single_handler(self):
        """
    ...
    def test_adding_all_single_handler(self):
        """
    ...
    def test_adding_and_remove_single_handler(self):
        """
        Validates that we can add a single handler to empty lists.
        """
        handlers = TestHandlers()
    ...
    def test_adding_single_handler_twice(self):
        """
    ...
    def test_adding_handlers_when_added_through_construction(self):
        """
    ...
    def test_remove_handlers_when_added_through_construction(self):
        """
